...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'nanorag.base': { 'nanorag.base.BaseNode': ('base.html#basenode', 'nanorag/base.py'),
            ...
            'nanorag.context': { 'nanorag.context.ModelContext': ('context.html#modelcontext', 'nanorag/context.py'),
                                   'nanorag.context.ModelContext.__init__': ( 'context.html#modelcontext.__init__',
                                                                                'nanorag/context.py')},
            ...
            'nanorag.loaders': { 'nanorag.loaders.DocumentBridge': ('loaders.html#documentbridge', 'nanorag/loaders.py'),
                                   'nanorag.loaders.DocumentBridge.__init__': ( 'loaders.html#documentbridge.__init__',
                                                                                  'nanorag/loaders.py'),
                                   'nanorag.loaders.DocumentBridge.join': ('loaders.html#documentbridge.join', 'nanorag/loaders.py'),
                                   'nanorag.loaders.DocumentBridge.nodes': ('loaders.html#documentbridge.nodes', 'nanorag/loaders.py'),
                                   ...
                                   'nanorag.loaders.PDFLoader.get_documents': ( 'loaders.html#pdfloader.get_documents',
                                                                                  'nanorag/loaders.py'),
                                   ...
                                   'nanorag.loaders.PDFLoader.load_random_pdf': ( 'loaders.html#pdfloader.load_random_pdf',
                                                                                    'nanorag/loaders.py'),
                                   'nanorag.loaders.PDFLoader.pdf_validator': ( 'loaders.html#pdfloader.pdf_validator',
                                                                                  'nanorag/loaders.py')},
            'nanorag.store': { 'nanorag.store.BaseDocumentStore': ('store.html#basedocumentstore', 'nanorag/store.py'),
                                 'nanorag.store.BaseDocumentStore.__call__': ( 'store.html#basedocumentstore.__call__',
                                                                                 'nanorag/store.py'),
                                 'nanorag.store.BaseDocumentStore.__init__': ( 'store.html#basedocumentstore.__init__',
                                                                                 'nanorag/store.py'),
